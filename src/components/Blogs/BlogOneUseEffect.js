  ...
  return (
    <>
     <Container fluid className="project-section">
      ...
      useEffect is a hook in React that allows developers to execute side effects in function components. Side effects can be any code that affects the state of the application beyond the scope of the current function, such as fetching data from an API, updating the DOM, or subscribing to events. By using useEffect, developers can ensure that these effects are executed only when necessary, and avoid duplicating code or causing infinite loops.
